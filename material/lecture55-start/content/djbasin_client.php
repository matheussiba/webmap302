...
//      ************* GBH Functions
            ...
            $("#btnRaptorSurveys").click(function(){
                ...
                $.ajax({
                    ...
                    data:{tbl:"dj_raptor_survey", title:'Surveys for Raptor Nest '+search_id, order:'surveydate DESC', flds:'surveyor AS "Surveyor", surveydate AS "Survey Date", result AS "Result"', where:whr},
                    type:'POST',
                    success:function(response){
                        $("#tableData").html(response);
                        $("#dlgModal").show();
            ...
            $("#btnBUOWLsurveys").click(function(){
                ...
                $.ajax({
                    url:'php/load_table.php',
                    data:{tbl:"dj_buowl_survey", title:'Surveys for BUOWL Habitat '+search_id, order:'surveydate DESC', flds:'surveyor AS "Surveyor", surveydate AS "Survey Date", result AS "Result"', where:whr},
                    type:'POST',
                    success:function(response){
                        $("#tableData").html(response);
                        $("#dlgModal").show();
            ...
            $("#btnEagleSurveys").click(function(){
                ...
                $.ajax({
                    url:'php/load_table.php',
                    data:{tbl:"dj_eagle_survey", title:'Surveys for Eagle Nest '+search_id, order:'surveydate DESC', flds:'surveyor AS "Surveyor", surveydate AS "Survey Date", result AS "Result"', where:whr},
                    type:'POST',
                    success:function(response){
                        $("#tableData").html(response);
                        $("#dlgModal").show();
