...
<html lang="en">
    ...
    <body>
        <div id="side-bar" class="col-md-3">
            ...
            <button id="btnShowModal" class='btn btn-primary btn-block'>Show Modal</button>
            <div id="legend">
            ...
            <div id="divProject" class="col-xs-12">
                <div id="divProjectLabel" class="text-center col-xs-12">
                    <h4 id="lblProject">Linear Projects <button id="btnRefreshLinears" class=" btn btn-info"><i class="fa fa-refresh"></i></button></h4>
                </div>
